  ...
  return (
    <div className="p-2">
      <motion.svg width="24" height="24" viewBox="0 0 24 24" fill="none" initial="hidden" animate="visible">
        ...
        {/* 勾号 */}
        <motion.path d="M8 12L11 15L16 9" stroke={themeVars.colors.palette.success.default} strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" fill="none" variants={checkmarkVariants} />
      </motion.svg>
    </div>
  );
};
...
const ErrorIcon = () => {
  ...
  return (
    <div className="p-2">
      <motion.svg width="24" height="24" viewBox="0 0 24 24" fill="none" initial="hidden" animate={['visible', 'pulse']} variants={shakeVariants}>
        <motion.circle
          cx="12"
          cy="12"
          r="11"
        ...
        {/* 主圆圈 */}
        <motion.circle cx="12" cy="12" r="10" stroke={themeVars.colors.palette.error.default} strokeWidth="2" fill="none" variants={circleVariants} />

        {/* 交叉线 */}
        <motion.path d="M8 8L16 16" stroke={themeVars.colors.palette.error.default} strokeWidth="2.5" strokeLinecap="round" custom={0} variants={crossVariants} />
        <motion.path d="M16 8L8 16" stroke={themeVars.colors.palette.error.default} strokeWidth="2.5" strokeLinecap="round" custom={1} variants={crossVariants} />
      </motion.svg>
    </div>
  );
};
